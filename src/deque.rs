...
///
/// ```
/// use crossbeam_intrusion::{Steal, Worker};
///
...
impl<T> Worker<T> {
    ...
    ///
    /// ```
    /// use crossbeam_intrusion::Worker;
    ///
...
///
/// ```
/// use crossbeam_intrusion::{Injector, Steal};
///
/// let q = Injector::new();
/// q.push(1);
/// q.push(2);
...
impl<K: GetIntrusive<QueueTypes<K, T>> + 'static, T: SharedPointer> Injector<K, T> {
    ...
    ///
    /// ```
    /// use crossbeam_intrusion::Injector;
    ///
    ...
    ///
    /// ```
    /// use crossbeam_intrusion::{Injector, Steal, Worker};
    ///
    /// let q = Injector::new();
    /// q.push(1);
    /// q.push(2);
...
///
/// ```
/// use crossbeam_intrusion::Steal::{self, Empty, Retry, Success};
///
...
impl<T> Steal<T> {
    ...
    ///
    /// ```
    /// use crossbeam_intrusion::Steal::{Empty, Retry, Success};
    ///
